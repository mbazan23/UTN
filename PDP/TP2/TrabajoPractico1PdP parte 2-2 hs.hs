...
ifnz (Microcontrolador memoriaDeDatos (0,b) programCounter etiquetaError programa)= Microcontrolador memoriaDeDatos (0,b) programCounter etiquetaError []
ifnz microcontrolador=(aumentarPc.ejecutarPrograma) microcontrolador
